...
# Pre-defined configs
##
from .drone_race_asset import _2_DRONES_PAYLOAD_CFG  # isort: skip
...
class QuadcopterEnvCfg(DirectRLEnvCfg):
    ...
    # robot
    robot:  ArticulationCfg = _2_DRONES_PAYLOAD_CFG.replace(prim_path="/World/envs/env_.*/Robot")
...
class QuadcopterEnv(DirectRLEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        payload_state = self._robot.data.body_state_w[:, self._payload_sphere_id, :]
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        died = bad_height | bad_ang_vel_1 | bad_ang_vel_2 | bad_state | bad_payload_acc | bad_tilt_1 | bad_tilt_2
