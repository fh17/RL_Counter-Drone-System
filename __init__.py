...
gym.register(
    id="Isaac-Quadcopter-Direct-OUR_DRONES-v0",
    entry_point=f"{__name__}.env_FRANCO_our_drone_3_curriculum:QuadcopterEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.env_FRANCO_our_drone_3_curriculum:QuadcopterEnvCfg",
